...
printf "Checking if /var/log/messages is 0600: "
if stat -c "%a %n"  /var/log/messages | grep "0600" >/dev/null ; then
	printf "\e[32mPASS\e[0m\n"
else
	printf "\e[31mFAIL\e[0m\n"
fi

printf "Checking if /var/log/messages is 0640: "
if stat -c "%a %n"  /var/log/messages | grep "0640" >/dev/null ; then
	printf "\e[32mPASS\e[0m\n"
else
	printf "\e[31mFAIL\e[0m\n"
fi
...
printf "Checking if /var/log/secure is 0600: "
if stat -c "%a %n"  /var/log/secure | grep "0600" >/dev/null ; then
	printf "\e[32mPASS\e[0m\n"
else
	printf "\e[31mFAIL\e[0m\n"
fi

printf "Checking if /var/log/secure is 0640: "
if stat -c "%a %n"  /var/log/secure | grep "0640" >/dev/null ; then
	printf "\e[32mPASS\e[0m\n"
else
	printf "\e[31mFAIL\e[0m\n"
fi
...
printf "Checking if /var/log/maillog is 0600: "
if stat -c "%a %n"  /var/log/maillog | grep "0600" >/dev/null ; then
	printf "\e[32mPASS\e[0m\n"
else
	printf "\e[31mFAIL\e[0m\n"
fi
...
if stat -c "%a %n"  /var/log/maillog | grep "0640" >/dev/null ; then
	printf "\e[32mPASS\e[0m\n"
else
	printf "\e[31mFAIL\e[0m\n"
fi
...
printf "Checking if /var/log/cron is 0600: "
if stat -c "%a %n"  /var/log/cron | grep "0600" >/dev/null ; then
	printf "\e[32mPASS\e[0m\n"
else
	printf "\e[31mFAIL\e[0m\n"
fi

printf "Checking if /var/log/cron is 0640: "
if stat -c "%a %n"  /var/log/cron | grep "0640" >/dev/null ; then
	printf "\e[32mPASS\e[0m\n"
else
	printf "\e[31mFAIL\e[0m\n"
fi
...
printf "Checking if /var/log/spooler is 0600: "
if stat -c "%a %n"  /var/log/spooler | grep "0600" >/dev/null ; then
	printf "\e[32mPASS\e[0m\n"
else
	printf "\e[31mFAIL\e[0m\n"
fi

printf "Checking if /var/log/spooler is 0640: "
if stat -c "%a %n"  /var/log/spooler | grep "0640" >/dev/null ; then
	printf "\e[32mPASS\e[0m\n"
else
	printf "\e[31mFAIL\e[0m\n"
fi
...
printf "Checking if /var/log/boot.log is 0600: "
if stat -c "%a %n"  /var/log/boot.log | grep "0600" >/dev/null ; then
	printf "\e[32mPASS\e[0m\n"
else
	printf "\e[31mFAIL\e[0m\n"
fi

printf "Checking if /var/log/boot.log is 0640: "
if stat -c "%a %n"  /var/log/boot.log | grep "0640" >/dev/null ; then
	printf "\e[32mPASS\e[0m\n"
else
	printf "\e[31mFAIL\e[0m\n"
fi
...
if (grep access /etc/audit/audit.rules | grep "a always,exit -F arch=b64 -S creat -S openat -S truncate -S ftruncate -F exit=-EACCES -F auid>=1000 -F auid!=4294967295 -k access" >/dev/null) && (grep access /etc/audit/audit.rules | grep "a always,exit -F arch=b32 -S creat -S openat -S truncate -S ftruncate -F exit=-EACCES -F auid>=1000 -F auid!=4294967295 -k access" >/dev/null) && (grep access /etc/audit/audit.rules | grep "a always,exit -F arch=b64 -S creat -S openat -S truncate -S ftruncate -F exit=-EPERM -F auid>=1000 -F auid!=4294967295 -k access" >/dev/null) && (grep access /etc/audit/audit.rules | grep "a always,exit -F arch=b32 -S creat -S openat -S truncate -S ftruncate -F exit=-EPERM -F auid>=1000 -F auid!=4294967295 -k access" >/dev/null) ; then
	printf "\e[32mPASS\e[0m\n"
else
	printf "\e[31mFAIL\e[0m\n"
fi
...
if (grep delete /etc/audit/audit.rules | grep "a always,exit -F arch=b64 -S unlink -S unlinkat -S rename -S renameat -F auid>=1000 -F auid!=4294967295 -k mounts" >/dev/null) && (grep delete /etc/audit/audit.rules | grep "a always,exit -F arch=b32 -S unlink -S unlinkat -S rename -S renameat -F auid>=1000 -F auid!=4294967295 -k mounts" >/dev/null) ; then
	printf "\e[32mPASS\e[0m\n"	
else
	printf "\e[31mFAIL\e[0m\n"
fi
